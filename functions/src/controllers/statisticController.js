...
const { getThirdStatisticService, getFourthStatisticService, getTotalStatisticService } = require('../service/statisticService');
...
module.exports = { getThirdStatisticController, getFourthStatisticController,
